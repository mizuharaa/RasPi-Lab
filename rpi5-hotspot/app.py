from flask import Flask,request #Lightweight webserver to serve connectivity purposes
import subprocess #Let python run shell commands in Linux environment
app = Flask(__name__)
...
if __name__ == '__main__':
    app.run(debug=True, host='0.0.0.0', port=80) #Starts a Flask web server on port 80
